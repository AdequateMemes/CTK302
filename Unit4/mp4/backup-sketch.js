...
function setup() {
  ...
  var myCityString = 'https://api.openweathermap.org/data/2.5/onecall?lat=' + lat + '&lon=' + long + '&units=imperial&' // geo implementation
...
function draw() {
  switch (myState) {
    ...
    case 1:
      ...
      text("The windspeed is " + windspeed + " mph.", 20, 400);
